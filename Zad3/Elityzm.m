...
chromlength = param.L;
[funkcja_najlepszego_obecnie_osobnika]=min(pop(:,chromlength+2));
[funkcja_najlepszego_poprzedniego_osobnika,index_najlepszego_poprzedniego_osobnika]=min(poprzednia_populacja(:,chromlength+2));
