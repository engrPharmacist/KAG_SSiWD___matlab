...
%-------------------------------------------------------------------------
param.K = 8 * 4 ;            % liczba chromosomow K w popoulacji (ze wzgledu na przyjeta strategie powinna byc parzysta)
...
param.pc = 0.8;        % prawdopodobienstwo krzyzowania
param.pm = 0.2;        % prawdopodobienstwo mutacji

Warunek_stopu = 26;     % definicja ilości generacji bez poprawy najlepszego do zatrzymania algorytmu
